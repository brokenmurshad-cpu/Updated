    ...
    >
      <button
        ...
        className={cn(
          ...
          "shadow-[0_10px_40px_rgba(0,0,0,0.35)] transition-[background-color,transform,box-shadow] duration-300 hover:scale-105 hover:shadow-[0_0_0_7px_rgba(10,143,135,0.15),0_10px_40px_rgba(0,0,0,0.38)]",
          isOpen && "border-[#31b8ae]/50 bg-[#090917] shadow-[0_0_0_7px_rgba(10,143,135,0.17),0_0_28px_rgba(10,143,135,0.62)]",
        )}
      >
