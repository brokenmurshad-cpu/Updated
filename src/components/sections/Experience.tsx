    ...
    >
      <div className="mx-auto w-full max-w-[112rem]">
        <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            ...
            <RevealText
              ...
              className="max-w-[86rem] break-words font-display text-[clamp(2.3rem,6.8vw,8rem)] font-extrabold uppercase leading-[0.88] tracking-[-0.06em] text-white sm:leading-[0.82] sm:tracking-[-0.075em]"
            />
          </div>
        ...
        <div className="relative mt-[clamp(5rem,10vw,10rem)]">
          ...
          <div
            ref={lineRef}
            className="absolute bottom-0 left-[11px] top-0 w-[3px] origin-top bg-gradient-to-b from-white via-[#75b8b1] to-[#004643]/55 shadow-[0_0_18px_rgba(255,255,255,0.6),0_0_50px_rgba(10,143,135,0.95),0_0_92px_rgba(0,70,67,0.68)] md:left-[calc(33%_-_1px)]"
          />
          ...
          <div className="space-y-16 md:space-y-24">
            {experience.map((item, index) => (
              ...
              >
                <span className="absolute left-[7px] top-2 h-2.5 w-2.5 rounded-full border-2 border-[#090917] bg-white shadow-[0_0_12px_rgba(255,255,255,0.95),0_0_28px_rgba(10,143,135,0.95)] md:left-[calc(33%_-_5px)]" />
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#31b8ae]">
                    {item.period}
                  </p>
