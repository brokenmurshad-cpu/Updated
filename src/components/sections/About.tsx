    ...
    >
      <div className="mx-auto w-full max-w-[112rem]">
        ...
        <RevealText
          ...
          accentWords={["Developer"]}
          className="mx-auto max-w-[96rem] break-words text-balance text-center font-display text-[clamp(2.15rem,6.65vw,8.4rem)] font-extrabold uppercase leading-[0.88] tracking-[-0.06em] text-[#f2f3f4] sm:leading-[0.82] sm:tracking-[-0.075em] lg:mx-0 lg:text-left"
        />
